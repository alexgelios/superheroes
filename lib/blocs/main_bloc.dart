...
class MainBloc {
  ...
  Stream<List<SuperheroInfo>> observeFavoritSuperheroes() =>
      favoriteSuperheroesSubject;
  ...
  Future<List<SuperheroInfo>> search(final String text) async {
    ...
    return List.from(SuperheroInfo.mocked.where((SuperheroInfo) => SuperheroInfo.name.toString().toUpperCase().contains(text.toUpperCase())));
  }
